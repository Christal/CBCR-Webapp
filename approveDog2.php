...
<body>
	...
	<div id="container">
		...
		<div class='cols1'>
			...
			<form name="approveDog" action= "approveDog.php" method="POST">
				<input type="hidden" name="dogID" value="<?php echo $dog['ID']; ?>"/>
				<h3>Approve: </h3> <select name="Approve" size=1>
				<option value="0"<?php if($dog['admin'] == "0") echo 'selected="selected"'; ?>>Public</option>
			 	<option value="1" <?php if($dog['member'] == "1") echo 'selected="selected"'; ?>>Private</option>
				<option value="2" <?php if($dog['admin'] == "1") echo 'selected="selected"'; ?>>Admin</option>
				</select>
				<input type="submit" value="Set Visibility of Dog"/></td>
			</form>
